...
from environmentSB3 import MMSequenceDecisionAdaptiveEnvironmentSB3, ReverseSequenceDecisionAdaptiveEnvironmentSB3, \
    RandomWalkSequenceDecisionAdaptiveEnvironmentSB3
...
def trainer(total_timesteps, _version, envName, expNo, episode_length, env_class, env_args, tr_args, load_env_path,

...
class FixObsSequenceDecisionAdaptiveEnvironmentSB3(SequenceDecisionAdaptiveEnvironmentSB3):
    ...
    def step(self, action):
        ...
        new_obs = np.concatenate([self.encode_obs_MM(self.history_channel_information_error_norm, self.history_action).reshape(-1), self.history_action.reshape(-1, ), channel_damage_info], axis=-1)
        terminated, truncated, info = False, False, {}

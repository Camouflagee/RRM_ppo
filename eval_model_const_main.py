...
#     num_pair=[]
#     test_num=50
#     unwrapped_env = load_env(f'Experiment_result/seqPPOcons_R2A2/UE{nUE}RB{nRB}/ENV/env.zip')
...
for idx, (model_path,error_rate) in enumerate(zip(model_path_list,[0,0.05,0.1,0.2])):
    Nrb=15
    nUE=12
    nRB=30
    np.random.seed(0)

...
model_path_list=[
    'Experiment_result/seqPPOcons/UE5RB10/E1_Nrb3/date20250311time150423/model_saves/eval_best_model/best_model.zip',
    'Experiment_result/seqPPOcons/UE10RB20/E1_Nrb3/date20250312time231339/model_saves/eval_best_model/best_model.zip',
...
for idx, (nUE, nRB, episode_length,model_path) in enumerate(zip([5, 10, 12, 15], [10, 20, 30, 40],[12,21,27,40],model_path_list)):# 12,30,27; 10,20,21; 5,10,12; UE,RB,episode_length
    np.random.seed(0)
    res=[]
    num_pair=[]
    test_num=50
